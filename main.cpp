...
int main()
{
	...
	do
	{
		...
		case 'L':
		{
			if (!(stats.dArr.empty()))
			{
				stats.dArr.sort();   //dataset is sorted first
				stats.quartiles();   //call quartiles function
			}
			else
			{
		...
		case 'M':
		{
			...
			{
				stats.dArr.sort();   //dataset is sorted first
				stats.interquartile();   //call interquartile function
			}
			else
			{
		...
		case 'N':
		{
			...
			{
				stats.dArr.sort();   //dataset is sorted first
				stats.outliers();   //call outlier function
			}
			else
			{
				cout << "\n\tArray is empty or ptr is null\n\n";
		...
		case 'O':
		{
			...
			{
				stats.dArr.sort();   //dataset is sorted first
				stats.sumOfSquares();   //call sumOfSquares function
			}
			else
			{
				cout << "\n\tArray is empty or ptr is null\n\n";
		...
		case 'P':
		{
			...
			{
				stats.dArr.sort();   //dataset is sorted first
				stats.meanAbsoluteDeviation();   //call sumOfSquares function
			}
			else
			{
				cout << "\n\tArray is empty or ptr is null\n\n";
		...
		case 'Y':
		{
			if (!(stats.dArr.empty()))
			{
				...
				cout << setw(setw_DisplayWidth) << "\n\tSkewness" << "= "; cout << stats.skewness(); // Broken
				cout << setw(setw_DisplayWidth) << "\n\tKurtosis" << "= "; cout << stats.kurtosis(); // Broken
				cout << setw(setw_DisplayWidth) << "\n\tKurtosis Excess" << "= "; cout << stats.kurtosisExcess(); // Broken
				cout << setw(setw_DisplayWidth) << "\n\tCoefficient Variation" << "= "; cout << stats.coeficientOfVariation(); // EH
